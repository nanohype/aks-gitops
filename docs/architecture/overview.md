...
| 1 | Networking | Cilium, ingress-nginx, External DNS |
| 2 | Bootstrap | metrics-server, reloader, storage-classes, priority-classes |
| 5 | Karpenter | Karpenter for Azure (nodes ready before workloads) |
...
- **storage-classes** — Azure managed disk StorageClasses (Premium SSD default)
- **priority-classes** — PriorityClass resources for platform and tenant workload tiers
- **karpenter-resources** — AKSNodeClass and NodePool CRDs with environment-specific patches
